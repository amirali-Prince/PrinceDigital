...
export const T = {
  de: {
    ...
    hero: {
      ...
      sub: 'Prince Digital entwickelt digitale Präsenzen, die Ihre Konkurrenz alt aussehen lassen — strategisch durchdacht, handwerklich perfekt, messbar im Ergebnis.',
  ...
  en: {
    ...
    hero: {
      ...
      sub: 'Prince Digital builds digital presences that make your competition look outdated — strategic, precise, measurable in results.',
      cta1: 'Start Project',
      cta2: 'Our Work',
